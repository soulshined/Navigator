...
export default class LineFirstCharOccurrenceCommand extends NavigatorCommand {

    constructor() {
        super(Constants.COMMANDS.JUMP_TO_LINE_FIRST_CHAR_OCCURRENCE, NavigatorCommandValueType.SINGLE_CHAR);
    ...
    protected setCallback(): (args: CommandArgs) => Promise<CommandResult | undefined> {
        return async (args: CommandArgs) => {
            ...
            for (let i = 0; i < selCount; ++i) {
                ...
                const pos = new Position(selection.active.line, index);
